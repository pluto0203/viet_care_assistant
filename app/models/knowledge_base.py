...
class KBCollection(Base):
    ...
    collection_id = Column("collection_id", Integer, primary_key=True, index=True, autoincrement=True)
...
class KBFAQ(Base):
    ...
    faq_id = Column("faq_id", BigInteger, primary_key=True, index=True, autoincrement=True)
